        ...
        <Section id='contact' data-section>
            <div className='mt-10 pb-20'>
                <div>
                    ...
                    <div className=''>
                        <div className="block w-full dark:shadow-[0_0px_5px_1px_rgba(255,255,255,0.3)] bg-white border border-gray-200 shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                    ...
                                    <ul className='flex py-6 h-full flex-col justify-between relative z-30'>
                                        <li className='flex items-center'>
                                            <span className='w-5 h-5 mr-3'>
                                                ...
                                                {/* <Image className='dark:text-white' width={20} height={20} src="/icons/gmail.svg" alt='gmail-icon' /> */}
                                            </span>
                                        ...
                                        <li className='flex items-center'>
                                            <span className='w-5 h-5 mr-3'>
                                                ...
                                                {/* <Image width={20} height={20} src="/icons/telephone.svg" alt='Mobile' /> */}
                                            </span>
