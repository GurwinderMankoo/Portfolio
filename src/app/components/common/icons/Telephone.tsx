...
export default function Telephone({ width, height }: Props) {
    return (
        <svg version="1.1" width={width} height={height} className='text-black dark:text-white fill-current' id="Phone-14" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 28.314 28.323" style={{ background: "new 0 0 28.314 28.323;" }} xmlSpace="preserve">
